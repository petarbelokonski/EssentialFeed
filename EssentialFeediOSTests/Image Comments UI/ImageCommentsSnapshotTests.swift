        ...
        return [
            ImageCommentCellController(
                model: ImageCommentViewModel(
                    message: "The East Side Gallery is an open-air gallery in Berlin. The East Side Gallery is an open-air gallery in Berlin. The East Side Gallery is an open-air gallery in Berlin. The East Side Gallery is an open-air gallery in Berlin.",
                    date: "1000 years ago",
